...
> **Task 7.18 concluída:** `BonusDeals` substitui a seção inline legada por op-cards V4 com disclosure; somente ofertas `verified` e vigentes no locale são exibidas (RedTrack, AdHeart, Anstrex — ordem aprovada), expirados e não confirmados permanecem ocultos, cupons são reais e os hrefs localizados.
> **Próxima task técnica recomendada:** **7.19 — Radar Market**, categorias reais e estado transparente, itens somente quando publicados.
