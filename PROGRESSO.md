...
> **Task 7.17 concluída:** `ToolDirectory` substitui a seção inline legada por módulo V4 comercial com disclosure visível; categorias de parceiros carregadas do loader central com descrições localizadas (ES sem cópia PT), hrefs via `routePath`, fallback localizado quando vazio.
> **Próxima task técnica recomendada:** **7.18 — Bônus**, módulo V4 para ofertas verificadas, vigentes e localizadas.
